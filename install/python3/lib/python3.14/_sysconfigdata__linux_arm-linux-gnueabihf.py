...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/opt/python3.14/bin',
    'BINLIBDEST': '/opt/python3.14/lib/python3.14',
    'BLDLIBRARY': 'libpython3.14.a',
    'BLDSHARED': 'gcc -std=gnu11 -pthread -shared -L/opt/openssl-3/lib -L/opt/openssl-3/lib',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    ...
    'CONFIGURE_CPPFLAGS': '-I/opt/openssl-3/include',
    'CONFIGURE_LDFLAGS': '-L/opt/openssl-3/lib',
    'CONFIGURE_LDFLAGS_NODIST': '',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--prefix=/opt/python3.14' '--with-ensurepip=install' '--with-openssl=/opt/openssl-3' 'LDFLAGS=-L/opt/openssl-3/lib' 'CPPFLAGS=-I/opt/openssl-3/include'",
    'CONFINCLUDEDIR': '/opt/python3.14/include',
    'CONFINCLUDEPY': '/opt/python3.14/include/python3.14',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/tmp/Python-3.14.3/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/tmp/Python-3.14.3/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.14 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include -I/opt/openssl-3/include -I/opt/openssl-3/include',
    'CXX': 'g++ -pthread',
    'DESTDIRS': '/opt/python3.14 /opt/python3.14/lib /opt/python3.14/lib/python3.14 /opt/python3.14/lib/python3.14/lib-dynload',
    'DESTLIB': '/opt/python3.14/lib/python3.14',
    'DESTPATH': '',
    'DESTSHARED': '/opt/python3.14/lib/python3.14/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/opt/python3.14/bin/python3.14',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/opt/python3.14/include /opt/python3.14/include /opt/python3.14/include/python3.14 /opt/python3.14/include/python3.14',
    'INCLUDEDIR': '/opt/python3.14/include',
    'INCLUDEPY': '/opt/python3.14/include/python3.14',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'g++ -pthread -shared -L/opt/openssl-3/lib -L/opt/openssl-3/lib',
    'LDFLAGS': '-L/opt/openssl-3/lib -L/opt/openssl-3/lib',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.14.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'gcc -std=gnu11 -pthread -shared -L/opt/openssl-3/lib -L/opt/openssl-3/lib',
    'LDVERSION': '3.14',
    'LIBC': '',
    'LIBDEST': '/opt/python3.14/lib/python3.14',
    'LIBDIR': '/opt/python3.14/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/opt/openssl-3/include -I/opt/openssl-3/include -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_32=1 -DANSI=1 -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/opt/openssl-3/include -I/opt/openssl-3/include -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/opt/python3.14/lib/pkgconfig',
    'LIBPL': '/opt/python3.14/lib/python3.14/config-3.14-arm-linux-gnueabihf',
    'LIBPYTHON': '',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/opt/python3.14/lib/python3.14',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/opt/python3.14/share/man',
    'MIMALLOC_HEADERS': '\\',
    'MKDIR_P': '/bin/mkdir -p',
    ...
    'MODULE_BINASCII_LDFLAGS': '-L/usr/lib/arm-linux-gnueabihf -lz',
    ...
    'MODULE_ZLIB_CFLAGS': '',
    'MODULE_ZLIB_LDFLAGS': '-L/usr/lib/arm-linux-gnueabihf -lz',
    ...
    'MODULE__CURSES_CFLAGS': '-I/usr/include/ncursesw',
    'MODULE__CURSES_DEPS': './Include/py_curses.h',
    'MODULE__CURSES_LDFLAGS': '-lncurses',
    'MODULE__CURSES_PANEL_CFLAGS': '-I/usr/include/ncursesw -I/usr/include/ncursesw',
    ...
    'MODULE__HASHLIB_CFLAGS': '-I/opt/openssl-3/include',
    'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
    'MODULE__HASHLIB_LDFLAGS': '-L/opt/openssl-3/lib   -lcrypto',
    ...
    'MODULE__SRE_LDFLAGS': '',
    'MODULE__SSL_CFLAGS': '-I/opt/openssl-3/include',
    ...
    'MODULE__SSL_LDFLAGS': '-L/opt/openssl-3/lib  -lssl -lcrypto',
    ...
    'PY_CORE_LDFLAGS': '-L/opt/openssl-3/lib -L/opt/openssl-3/lib',
    'PY_CPPFLAGS': '-I. -I./Include -I/opt/openssl-3/include -I/opt/openssl-3/include',
    'PY_ENABLE_SHARED': 0,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-L/opt/openssl-3/lib -L/opt/openssl-3/lib',
    'PY_LDFLAGS_NODIST': '',
    'PY_LDFLAGS_NOLTO': '-L/opt/openssl-3/lib -L/opt/openssl-3/lib',
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': '/opt/python3.14/lib',
    'SCRIPT_IDLE': 'build/scripts-3.14/idle3.14',
    'SCRIPT_PYDOC': 'build/scripts-3.14/pydoc3.14',
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-314-arm-linux-gnueabihf.so Modules/_asyncio.cpython-314-arm-linux-gnueabihf.so Modules/_bisect.cpython-314-arm-linux-gnueabihf.so Modules/_csv.cpython-314-arm-linux-gnueabihf.so Modules/_heapq.cpython-314-arm-linux-gnueabihf.so Modules/_json.cpython-314-arm-linux-gnueabihf.so Modules/_lsprof.cpython-314-arm-linux-gnueabihf.so Modules/_pickle.cpython-314-arm-linux-gnueabihf.so Modules/_queue.cpython-314-arm-linux-gnueabihf.so Modules/_random.cpython-314-arm-linux-gnueabihf.so Modules/_remote_debugging.cpython-314-arm-linux-gnueabihf.so Modules/_struct.cpython-314-arm-linux-gnueabihf.so Modules/_interpreters.cpython-314-arm-linux-gnueabihf.so Modules/_interpchannels.cpython-314-arm-linux-gnueabihf.so Modules/_interpqueues.cpython-314-arm-linux-gnueabihf.so Modules/_zoneinfo.cpython-314-arm-linux-gnueabihf.so Modules/math.cpython-314-arm-linux-gnueabihf.so Modules/cmath.cpython-314-arm-linux-gnueabihf.so Modules/_statistics.cpython-314-arm-linux-gnueabihf.so Modules/_decimal.cpython-314-arm-linux-gnueabihf.so Modules/binascii.cpython-314-arm-linux-gnueabihf.so Modules/_bz2.cpython-314-arm-linux-gnueabihf.so Modules/zlib.cpython-314-arm-linux-gnueabihf.so Modules/readline.cpython-314-arm-linux-gnueabihf.so Modules/_md5.cpython-314-arm-linux-gnueabihf.so Modules/_sha1.cpython-314-arm-linux-gnueabihf.so Modules/_sha2.cpython-314-arm-linux-gnueabihf.so Modules/_sha3.cpython-314-arm-linux-gnueabihf.so Modules/_blake2.cpython-314-arm-linux-gnueabihf.so Modules/_hmac.cpython-314-arm-linux-gnueabihf.so Modules/pyexpat.cpython-314-arm-linux-gnueabihf.so Modules/_elementtree.cpython-314-arm-linux-gnueabihf.so Modules/_codecs_cn.cpython-314-arm-linux-gnueabihf.so Modules/_codecs_hk.cpython-314-arm-linux-gnueabihf.so Modules/_codecs_iso2022.cpython-314-arm-linux-gnueabihf.so Modules/_codecs_jp.cpython-314-arm-linux-gnueabihf.so Modules/_codecs_kr.cpython-314-arm-linux-gnueabihf.so Modules/_codecs_tw.cpython-314-arm-linux-gnueabihf.so Modules/_multibytecodec.cpython-314-arm-linux-gnueabihf.so Modules/unicodedata.cpython-314-arm-linux-gnueabihf.so Modules/fcntl.cpython-314-arm-linux-gnueabihf.so Modules/grp.cpython-314-arm-linux-gnueabihf.so Modules/mmap.cpython-314-arm-linux-gnueabihf.so Modules/_posixsubprocess.cpython-314-arm-linux-gnueabihf.so Modules/resource.cpython-314-arm-linux-gnueabihf.so Modules/select.cpython-314-arm-linux-gnueabihf.so Modules/_socket.cpython-314-arm-linux-gnueabihf.so Modules/syslog.cpython-314-arm-linux-gnueabihf.so Modules/termios.cpython-314-arm-linux-gnueabihf.so Modules/_posixshmem.cpython-314-arm-linux-gnueabihf.so Modules/_multiprocessing.cpython-314-arm-linux-gnueabihf.so Modules/_ctypes.cpython-314-arm-linux-gnueabihf.so Modules/_curses.cpython-314-arm-linux-gnueabihf.so Modules/_curses_panel.cpython-314-arm-linux-gnueabihf.so Modules/_ssl.cpython-314-arm-linux-gnueabihf.so Modules/_hashlib.cpython-314-arm-linux-gnueabihf.so Modules/xxsubtype.cpython-314-arm-linux-gnueabihf.so Modules/_xxtestfuzz.cpython-314-arm-linux-gnueabihf.so Modules/_testbuffer.cpython-314-arm-linux-gnueabihf.so Modules/_testinternalcapi.cpython-314-arm-linux-gnueabihf.so Modules/_testcapi.cpython-314-arm-linux-gnueabihf.so Modules/_testlimitedcapi.cpython-314-arm-linux-gnueabihf.so Modules/_testclinic.cpython-314-arm-linux-gnueabihf.so Modules/_testclinic_limited.cpython-314-arm-linux-gnueabihf.so Modules/_testimportmultiple.cpython-314-arm-linux-gnueabihf.so Modules/_testmultiphase.cpython-314-arm-linux-gnueabihf.so Modules/_testsinglephase.cpython-314-arm-linux-gnueabihf.so Modules/_ctypes_test.cpython-314-arm-linux-gnueabihf.so Modules/xxlimited.cpython-314-arm-linux-gnueabihf.so Modules/xxlimited_35.cpython-314-arm-linux-gnueabihf.so',
    'SHELL': '/bin/sh -e',
    ...
    'abs_builddir': '/tmp/Python-3.14.3',
    'abs_srcdir': '/tmp/Python-3.14.3',
    'datarootdir': '/opt/python3.14/share',
    'exec_prefix': '/opt/python3.14',
    'host_exec_prefix': '/opt/python3.14',
    'host_prefix': '/opt/python3.14',
